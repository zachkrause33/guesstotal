...
if (!key) {
  console.log('No RAINFOREST_API_KEY found.\n');
  console.log('Usage:');
  console.log('  RAINFOREST_API_KEY=your_key npm run bootstrap\n');
...
console.log('Step 1/3: Refreshing prices via Rainforest API...\n');
try {
